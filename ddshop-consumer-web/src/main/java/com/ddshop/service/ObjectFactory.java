 ...
 * generated in the com.ddshop.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://service.ddshop.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://service.ddshop.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ddshop.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ddshop.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ddshop.com/", name = "queryWeatherResponse")
